Status: profile 1.0.0. Legacy contracts remain available in the repository root and prior release tags.
...
Repository files at `source-path` are checked for consistency only and MUST NOT qualify as independent provenance in 1.0.0.
...
```json
{
  "verifier": {
    ...
    "verifier_profile_version": "1.0.0",
    "guide_profile": "human-verifiable-assistant-guide",
    "guide_profile_version": "1.0.0"
  },
  "input": {
  ...
  "guide": {
    "bytes": 3403,
    "sha256": "57ea123337d4b6679fe70e6ace6f64d0728d89a48f8b5d721428c3895dea1a8d",
    "achieved_level": 4,
    "level5_ready": true
  },
  "summary": {
  ...
  "findings": [
    {
      ...
      "severity": "info",
      "message": "last-reviewed is 107 days old"
    },
    {
  ...
  "manifest": {
    "sha256": "585b59ac211e35d68d7a8fa10cef75daa2a3d4a04032fbe8c7c8db572d5be73c",
    "fetched": true,
    "hash_match": true,
    "bytes_match": true,
    "valid": true,
    "guide_sha256": "57ea123337d4b6679fe70e6ace6f64d0728d89a48f8b5d721428c3895dea1a8d"
  },
  "cross_channel_anchors": [
    {
      "channel": "dns-txt",
      "status": "present-matches",
      "observed_sha256": "57ea123337d4b6679fe70e6ace6f64d0728d89a48f8b5d721428c3895dea1a8d",
...
## 28. Version-aware dispatch and reports
...
semantics. Version 1.0.0 selects this contract. Valid build metadata is ignored
...
Consumers requiring 1.0.0 MUST validate the returned 1.0.0 schema and evaluated
...
Each 1.0.0 anchor retains its hash/availability `status` and adds required
...
The 1.0.0 report MUST identify the declared version and evaluated policy through
`profile_selection`, the strict engine through `verifier`, and the number of
qualifying matches through `qualifying_anchor_count`. Repository evidence MUST
be shown as excluded in human output. Level, findings, hash-pinned status, and
proceed result MUST derive from the final selected evaluation. Neither a positive
conformance result nor `Proceed? yes` grants execution authority or implies safety.

The versioned [output schema](../../schemas/1.0.0/verifier-output.schema.json)
and [manifest schema](../../schemas/1.0.0/manifest.schema.json) define the new
...
additional 1.0.0 fields; they are mandatory for new-profile reports.
