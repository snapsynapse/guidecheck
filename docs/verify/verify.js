(function () {
  ...
  function renderEvaluated(data) {
    ...
    if (data.profile_selection && data.profile_selection.evaluated_policy) {
      var identity = "Profile " + data.profile_selection.evaluated_policy;
      if (data.profile_selection.content_policy) {
        identity += " · " + data.profile_selection.content_policy;
      }
      if (data.profile_selection.anchor_policy) {
        identity += " · anchors " + data.profile_selection.anchor_policy;
      }
      headline.textContent = identity + " · " + headline.textContent;
    }
