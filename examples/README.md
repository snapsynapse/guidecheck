...
- `level-3-assistant-guide.txt` — a full Level 3 guide: metadata block, all required sections, structured `[action]` blocks, approval gates, stop-and-ask conditions, acceptance checklist. ASCII byte profile, 5135 bytes.
